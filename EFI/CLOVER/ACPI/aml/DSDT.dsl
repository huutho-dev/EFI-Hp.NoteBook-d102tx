 ...
 *
 * Disassembly of DSDT.aml, Mon Apr 16 16:43:53 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000137DF (79839)
 *     Revision         0x02
 *     Checksum         0x6E
 *     OEM ID           "HPQOEM"
...
DefinitionBlock ("", "DSDT", 2, "HPQOEM", "SLIC-MPC", 0x00000000)
{
    ...
    External (_SB_.PCI0.IGPU.BCLM, FieldUnitObj)
    ...
    External (_SB_.PCI0.PEG1.PEGP, UnknownObj)
    ...
    Name (DPPL, 0x8000)
    OperationRegion (GNVS, SystemMemory, 0x9CFB7A98, 0x00000307)
    ...
    OperationRegion (OGNS, SystemMemory, 0x9CFB5018, 0x000012EC)
    ...
    OperationRegion (FGNS, SystemMemory, 0x9CFBED98, 0x0000010D)
    ...
    OperationRegion (HBFS, SystemMemory, 0x9CFBC018, 0x00001000)
    ...
    OperationRegion (HBFT, SystemMemory, 0x9CFBA018, 0x00001000)
    Field (HBFT, ByteAcc, Lock, Preserve)
    {
        TBUF,   32768
    }

    OperationRegion (HNBD, SystemMemory, 0x9CFB9F98, 0x00000028)
                    ...
                    Name (BUF0, ResourceTemplate()
{
    ...
    OperationRegion (ECMB, SystemIO, 0x0510, 0x02)
            ...
            Device (BAT0)
            {
                ...
                Method (_BST, 0, Serialized)  // _BST: Battery Status
                {
                    ...
                    If (ECON)
                    {
                        ...
                        Or (ShiftLeft (Local0, 0x08), FCCL, Local0)
                        Store (OG03, Local1)
                        Or (ShiftLeft (Local1, 0x08), OG02, Local1)
                        If (Local1)
                        {
...
Store (0xC4, SSMP)
    ...
    OperationRegion (MDBG, SystemMemory, 0x9CFB2018, 0x00001004)
    ...
    Scope (_SB)
    {
        Device (WMID)
        {
            ...
            {
                And (^^PCI0.IGPU.CBLV, 0xFF, Local1)
            ...
            Method (SBIG, 1, NotSerialized)
            {
                ...
                Else
                {
                    And (^^PCI0.IGPU.CBLV, 0xFF, Local0)
                    Store (Divide (Multiply (Local0, 0xFF), 0x64, ), Local0)
                    Store (SCBL (^^PCI0.IGPU.BCLM, Local0), OBLV)
                }

                Store (SCBL (^^PCI0.IGPU.BCLM, Arg0), NBLV)
                If (LEqual (NBLV, OBLV))
                {
                    If (LEqual (NBLV, Zero))
                    {
            ...
            Name (_WDG, Buffer (0x0104)
            {
                ...
                /* 0088 */  0x42, 0x44, 0x03, 0x00, 0x46, 0x97, 0xEA, 0x14,
