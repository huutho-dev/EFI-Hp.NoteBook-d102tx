 ...
 *
 * Disassembly of SSDT-3-225D.aml, Mon Apr 16 17:39:11 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000036FE (14078)
 *     Revision         0x01
 *     Checksum         0xAC
 *     OEM ID           "HPQOEM"
 *     OEM Table ID     "225D    "
 ...
 */
DefinitionBlock ("", "SSDT", 1, "HPQOEM", "225D    ", 0x00003000)
{
    /*
    ...
    External (_SB_.PCI0.LPCB.H_EC.OSVD, FieldUnitObj)
    External (_SB_.PCI0.PR02, PkgObj)
    External (_SB_.PCI0.PR0A, PkgObj)
    External (_SB_.PCI0.PR0B, PkgObj)
    External (_SB_.PEPD, UnknownObj)
    External (_SB_.WMID.BCM0, FieldUnitObj)
    External (_SB_.WMID.BCM1, FieldUnitObj)
    External (_SB_.WMID.BCM2, FieldUnitObj)
    External (_SB_.WMID.BCM3, FieldUnitObj)
    External (_SB_.WMID.BCM4, FieldUnitObj)
    External (_SB_.WMID.BCM5, FieldUnitObj)
    External (_SB_.WMID.BCM6, FieldUnitObj)
    External (_SB_.WMID.BCM7, FieldUnitObj)
    External (_SB_.WMID.BCM8, FieldUnitObj)
    External (_SB_.WMID.BCM9, FieldUnitObj)
    External (_SB_.WMID.BCMA, FieldUnitObj)
    ...
    External (PNID, FieldUnitObj)
    External (S0ID, FieldUnitObj)
    External (SCIS, FieldUnitObj)
    External (UBRL, FieldUnitObj)

    OperationRegion (SANV, SystemMemory, 0x9CFBEC18, 0x0141)
    ...
    Scope (\_SB.PCI0)
    {
        ...
        Device (IGPU)
        {
            ...
            Device (DD1F)
            {
                ...
                {
                    Name (_T_0, Zero)  // _T_x: Emitted by ASL Compiler
                    If (LEqual (\_SB.PCI0.LPCB.H_EC.OSVD, 0x03))
                    {
                        Store (Arg0, UBRL)
                    }
                    ...
                    Else
                    {
                        While (One)
                        {
                            ...
                            If (LEqual (_T_0, Zero))
                            {
                                And (\_SB.WMID.BCM0, 0xFF, Local0)
                                Break
                            }
                            ElseIf (LEqual (_T_0, 0x0A))
                            {
                                And (\_SB.WMID.BCM1, 0xFF, Local0)
                                Break
                            }
                            ElseIf (LEqual (_T_0, 0x14))
                            {
                                And (\_SB.WMID.BCM2, 0xFF, Local0)
                                Break
                            }
                            ElseIf (LEqual (_T_0, 0x1E))
                            {
                                And (\_SB.WMID.BCM3, 0xFF, Local0)
                                Break
                            }
                            ElseIf (LEqual (_T_0, 0x28))
                            {
                                And (\_SB.WMID.BCM4, 0xFF, Local0)
                                Break
                            }
                            ElseIf (LEqual (_T_0, 0x32))
                            {
                                And (\_SB.WMID.BCM5, 0xFF, Local0)
                                Break
                            }
                            ElseIf (LEqual (_T_0, 0x3C))
                            {
                                And (\_SB.WMID.BCM6, 0xFF, Local0)
                                Break
                            }
                            ElseIf (LEqual (_T_0, 0x46))
                            {
                                And (\_SB.WMID.BCM7, 0xFF, Local0)
                                Break
                            }
                            ElseIf (LEqual (_T_0, 0x50))
                            {
                                And (\_SB.WMID.BCM8, 0xFF, Local0)
                                Break
                            }
                            ElseIf (LEqual (_T_0, 0x5A))
                            {
                                And (\_SB.WMID.BCM9, 0xFF, Local0)
                                Break
                            }
