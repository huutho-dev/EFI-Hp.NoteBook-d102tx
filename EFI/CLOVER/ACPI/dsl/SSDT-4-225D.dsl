 ...
 *
 * Disassembly of SSDT-4-225D.aml, Mon Apr 16 17:39:11 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000376E (14190)
 *     Revision         0x01
 *     Checksum         0xC4
 *     OEM ID           "HPQOEM"
 *     OEM Table ID     "225D    "
 ...
 */
DefinitionBlock ("", "SSDT", 1, "HPQOEM", "225D    ", 0x00001000)
{
    ...
    {
        OperationRegion (VBOR, SystemMemory, 0x9CFA1018, 0x0000DE04)
    ...
    Scope (\_SB.PCI0.PEG1.PEGP)
    {
        OperationRegion (SGOP, SystemMemory, 0x9CFB9E98, 0x00000054)
    ...
    Scope (\_SB.PCI0.PEG1.PEGP)
    {
        OperationRegion (NOPR, SystemMemory, 0x9CF9F018, 0x00001014)
    ...
    Scope (\_SB.PCI0.PEG1)
    {
        OperationRegion (RPCX, SystemMemory, \_SB.PCI0.PEG1.PEGP.DBPA, 0x1000)
        ...
        {
            Store (Add (\_SB.PCI0.PEG1.PEGP.DBPA, Arg0), Local7)
        ...
        {
            Store (Add (Add (\_SB.PCI0.PEG1.PEGP.DBPA, 0x091C), Multiply (Arg0, 0x20)), Local7)
        ...
        {
            OperationRegion (MWHB, SystemMemory, \_SB.PCI0.PEG1.PEGP.XBAS, 0x1000)
        ...
        PowerResource (PG00, 0x00, 0x0000)
        {
            ...
            Method (_ON, 0, Serialized)  // _ON_: Power On
            {
                If (LEqual (MSD3, 0x03))
                {
                    ...
                    Store (\_SB.PCI0.PEG1.PEGP.DSSV, SSSV)
                    Store (One, _STA)
                    Store (Zero, MSD3)
                }
            }
    ...
    Scope (\_SB.PCI0.PEG1.PEGP)
    {
        ...
        OperationRegion (VGAR, SystemMemory, \_SB.PCI0.PEG1.PEGP.EBAS, 0x0100)
        ...
        OperationRegion (PCAP, PCI_Config, \_SB.PCI0.PEG1.PEGP.EECP, 0x14)
        ...
        Method (HGOF, 0, Serialized)
        {
            ...
            Store (EMLW, DMLW)
            SPP0 ()
            Store (One, \_SB.PCI0.PEG1.LNKD)
            Store (Zero, TCNT)
            While (LLess (TCNT, LDLY))
            {
                If (LEqual (\_SB.PCI0.PEG1.LNKS, Zero))
                {
                    Break
                }
        ...
        Method (SGPI, 1, Serialized)
        {
            If (And (SGMD, 0x0F))
            {
                If (LEqual (SGGP, One))
                {
                    ...
                    If (LLess (Arg0, 0x20))
                    {
                        Store (\_SB.PCI0.PEG1.PEGP.LVL0, Local0)
                        ShiftRight (Local0, Arg0, Local0)
                    }
                    ElseIf (LLess (Arg0, 0x40))
                    {
                        Store (\_SB.PCI0.PEG1.PEGP.LVL1, Local0)
                        ShiftRight (Local0, Subtract (Arg0, 0x20), Local0)
                    }
                    Else
                    {
                        Store (\_SB.PCI0.PEG1.PEGP.LVL2, Local0)
            ...
            If (And (SGMD, 0x0F))
            {
                If (LEqual (SGGP, One))
                {
                    ...
                    If (LLess (Arg0, 0x20))
                    {
                        ...
                        And (\_SB.PCI0.PEG1.PEGP.LVL0, Not (Local1), Local2)
                        Or (Local2, Local0, \_SB.PCI0.PEG1.PEGP.LVL0)
                    }
                    ElseIf (LLess (Arg0, 0x40))
                    {
                        ShiftLeft (Local3, Subtract (Arg0, 0x20), Local0)
                        ShiftLeft (One, Subtract (Arg0, 0x20), Local1)
                        And (\_SB.PCI0.PEG1.PEGP.LVL1, Not (Local1), Local2)
                        Or (Local2, Local0, \_SB.PCI0.PEG1.PEGP.LVL1)
                    }
                    Else
                    {
                        ShiftLeft (Local3, Subtract (Arg0, 0x40), Local0)
                        ShiftLeft (One, Subtract (Arg0, 0x40), Local1)
                        And (\_SB.PCI0.PEG1.PEGP.LVL2, Not (Local1), Local2)
                        Or (Local2, Local0, \_SB.PCI0.PEG1.PEGP.LVL2)
                    }
    ...
    Scope (\_SB.PCI0.IGPU)
    {
        ...
        Method (MXDS, 1, Serialized)
        {
            If (LEqual (Arg0, Zero))
            {
                Return (LNot (\_SB.PCI0.PEG1.PEGP.SGPI (\_SB.PCI0.PEG1.PEGP.DSEL)))
            }

            If (LEqual (Arg0, One))
            {
                \_SB.PCI0.PEG1.PEGP.SGPO (\_SB.PCI0.PEG1.PEGP.DSEL, Zero)
            }
    ...
    Scope (\_SB.PCI0.PEG1.PEGP)
    {
        ...
        Method (VSTS, 0, NotSerialized)
        {
            ...
            Store (GATD, \_SB.PCI0.PEG1.PEGP.MADL)
            Store (GACD, \_SB.PCI0.PEG1.PEGP.MSTE)
            Store (Zero, GATD)
            Store (Zero, GACD)
        }
        ...
        Method (GETD, 2, Serialized)
        {
            ...
            Name (_T_0, Zero)  // _T_x: Emitted by ASL Compiler
            VSTS ()
            Or (\_SB.PCI0.PEG1.PEGP.MADL, Arg0, \_SB.PCI0.PEG1.PEGP.MADL)
            Or (\_SB.PCI0.PEG1.PEGP.MSTE, Arg1, \_SB.PCI0.PEG1.PEGP.MSTE)
            While (One)
            {
                Store (ToInteger (\_SB.PCI0.PEG1.PEGP.MADL), _T_0)
                If (LEqual (_T_0, 0x07))
                {
                    While (One)
                    {
                        Store (ToInteger (\_SB.PCI0.PEG1.PEGP.MSTE), _T_1)
                        If (LEqual (_T_1, One))
                        {
                            Store (One, \_SB.PCI0.PEG1.PEGP.CTOI)
                            Store (0x02, \_SB.PCI0.PEG1.PEGP.NTOI)
                        }
                        ElseIf (LEqual (_T_1, 0x02))
                        {
                            Store (0x02, \_SB.PCI0.PEG1.PEGP.CTOI)
                            Store (0x03, \_SB.PCI0.PEG1.PEGP.NTOI)
                        }
                        ElseIf (LEqual (_T_1, 0x04))
                        {
                            Store (0x03, \_SB.PCI0.PEG1.PEGP.CTOI)
                            Store (0x04, \_SB.PCI0.PEG1.PEGP.NTOI)
                        }
                        ElseIf (LEqual (_T_1, 0x03))
                        {
                            Store (0x04, \_SB.PCI0.PEG1.PEGP.CTOI)
                            Store (0x05, \_SB.PCI0.PEG1.PEGP.NTOI)
                        }
                        ElseIf (LEqual (_T_1, 0x05))
                        {
                            Store (0x05, \_SB.PCI0.PEG1.PEGP.CTOI)
                            Store (0x06, \_SB.PCI0.PEG1.PEGP.NTOI)
                        }
                        ElseIf (LEqual (_T_1, 0x06))
                        {
                            Store (0x06, \_SB.PCI0.PEG1.PEGP.CTOI)
                            Store (One, \_SB.PCI0.PEG1.PEGP.NTOI)
                        }
                        Else
                        {
                            Store (One, \_SB.PCI0.PEG1.PEGP.CTOI)
                ...
                ElseIf (LEqual (_T_0, 0x06))
                {
                    While (One)
                    {
                        Store (ToInteger (\_SB.PCI0.PEG1.PEGP.MSTE), _T_2)
                        If (LEqual (_T_2, 0x02))
                        {
                            Store (0x02, \_SB.PCI0.PEG1.PEGP.CTOI)
                            Store (0x03, \_SB.PCI0.PEG1.PEGP.NTOI)
                ...
                ElseIf (LEqual (_T_0, 0x05))
                {
                    While (One)
                    {
                        Store (ToInteger (\_SB.PCI0.PEG1.PEGP.MSTE), _T_3)
                        If (LEqual (_T_3, One))
                        {
                            Store (One, \_SB.PCI0.PEG1.PEGP.CTOI)
                            Store (0x03, \_SB.PCI0.PEG1.PEGP.NTOI)
                ...
                ElseIf (LEqual (_T_0, 0x03))
                {
                    While (One)
                    {
                        Store (ToInteger (\_SB.PCI0.PEG1.PEGP.MSTE), _T_4)
                        If (LEqual (_T_4, One))
                        {
                            Store (One, \_SB.PCI0.PEG1.PEGP.CTOI)
                            Store (0x02, \_SB.PCI0.PEG1.PEGP.NTOI)
                ...
                Else
                {
                    While (One)
                    {
                        Store (ToInteger (\_SB.PCI0.PEG1.PEGP.MSTE), _T_5)
                        If (LEqual (_T_5, One))
                        {
                            Store (One, \_SB.PCI0.PEG1.PEGP.CTOI)
                            Store (One, \_SB.PCI0.PEG1.PEGP.NTOI)
            ...
            While (One)
            {
                ...
                ElseIf (LEqual (_T_0, 0x05))
                {
                    ...
                    ElseIf (ToInteger (DIMK))
                    {
                        ...
                        Store (\_SB.PCI0.PEG1.PEGP.NTOI, TOGN)
                        Store (One, DAVF)
                    }
                ...
                {
                    Return (\_SB.PCI0.PEG1.PEGP.GOBT (Arg3))
                }
        ...
        {
            If (LEqual (\_SB.PCI0.PEG1.PEGP.OMPR, 0x03))
            {
                \_SB.PCI0.PEG1.PEGP._OFF ()
                Store (One, DGOS)
                Store (0x02, \_SB.PCI0.PEG1.PEGP.OMPR)
            }
        }
        ...
        Method (MXDS, 1, Serialized)
        {
            If (LEqual (Arg0, Zero))
            {
                Return (\_SB.PCI0.PEG1.PEGP.SGPI (DSEL))
            }

            If (LEqual (Arg0, One))
            {
                \_SB.PCI0.PEG1.PEGP.SGPO (DSEL, One)
            }
